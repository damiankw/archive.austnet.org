  ...
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <p class="w3-text-grey"> 
        The Idle RPG can be played on the <a href="https://www.austnet.org/">AustNet Chat Network</a> in the
        channel #irpg. Connect to irc.austnet.org to join the fun!
      </p>
    </div>
  </div>
</div>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <ul class="w3-text-grey"><li>/msg idle REGISTER &lt;char name&gt; &lt;password&gt; &lt;char class&gt;</li></ul>
      ...
      <ul class="w3-text-grey"><li>/msg idle NEWPASS &lt;new password&gt;</li></ul>
      <p class="w3-text-grey">This is a p0 (see <a href="#penalties">penalties</a>) command.</p>
      ...
      <ul class="w3-text-grey"><li>/msg idle REMOVEME</li></ul>
      <p class="w3-text-grey">This is a p0 (see <a href="#penalties">penalties</a>) command :^)</p>
    
     <h1>CHANGING YOUR ALIGNMENT</h1>
      <p class="w3-text-grey">To change your alignment, simply:</p>
      <ul class="w3-text-grey"><li>/msg idle ALIGN &lt;good|neutral|evil&gt;</li></ul>
      <p class="w3-text-grey">This is a p0 (see <a href="#penalties">Penalties</a>) command.</p>
      ...
      <ul class="w3-text-grey"><li>/msg idle INFO</li></ul>
      <p class="w3-text-grey">This is a p0 (see <a href="#penalties">Penalties</a>) command.</p>
...
<footer class="w3-container w3-padding-20 w3-center w3-opacity">  
  <p>Updated by <a href="/cdn-cgi/l/email-protection#6c080d01050d022c0d191f1802091842031e0b">damian</a> for <a href="https://www.austnet.org/">AustNet</a>. Powered by <a href="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a></p>
</footer>
