...
-->
    ...
    <!-- header end -->
			...
			<div class="page-section">
				<div class="container">
					<h1 class="title text-center" id="asd_app">ASD Application</h1>
					<p class="lead text-center">"If you would like to apply for #ASD, please fill out the form below. Please use your registered AustNet account nickname & associated email address for verification purposes."</p>
					<div class="space"></div>
					<div class="row">

						<form id="asd-form" method="post" action="submit_asd.php" role="form">
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="form_message">Briefly explain why you should become a helper? *</label>
                                        <textarea id="form_message" name="message" class="form-control" placeholder="Type your explanation here *" rows="4" required="required" data-error="Message is required."></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
  ...
  <script>(function(){var js = "window['__CF$cv$params']={r:'7cf57b74bb23820e',m:'fLBZZKoM4HI7lPfJifAquchpGMfRWMcUE6kWpHsL24Y-1685434033-0-Ac1WubUl6FhsPbjvdwhOWLYNwmnRW+ndLNaVIG9OtYER',u:'/cdn-cgi/challenge-platform/h/b'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>
