...
function AjaxComment(form) {
	var url = 'http://austnet.org/WordPress/wp-content/themes/redoable 1.1/comments-ajax.php';
...
function initComment() {
	if ( document.getElementById('commentform') ) {
		...
		new Insertion.After('submit','<img src="http://austnet.org/WordPress/wp-content/themes/redoable 1.1/images/spinner.gif" id="commentload" />');
		$('commentload').hide();
		$('error').hide();
	}
}
