...
<head>
  ...
  <title>AustNet.org :: AustNet Board</title>
...
<body id="austnet">
  <div id="container">
    ...
    <div id="content">
      <div class="wrapper">
      <p><strong>AustNet Board </strong></p>
      <p>The AustNet Board is made up of two directors and two chair people who also act as directors. Each of the four members has an area of responsibility.  The two chair people carry out development and management roles along with assisting the other two directors.</p>
      <p><strong>Administration</strong><br />&#39;Ryan&#39; - Forming policies and monitoring the progress of the other members.</p>
      <p><strong>Admin/Services</strong> <br />&#39;RogerY&#39; - Services/ircd and web related interfaces.</p>
            <p><strong>Support</strong><br />&#39;Kevin&#39; - Managing and maintaining AustNet&#39;s support base, #ASD, #Help and mailing lists</p>
      <p><strong>Routing</strong><br />&#39;Trip&#39; - Responsible for routing the network along with maintaining DNS and web hosts.</p>      </div>
    </div>
    <div id="news">
