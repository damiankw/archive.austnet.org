...
var lsUrl = window.location.href.match(/^(http:\/\/[^/]+)/)[1]
	+ 'http://austnet.org/WordPress/wp-content/themes/redoable'.match(/^http:\/\/[^/]+(.+)/)[1];

new FastInit( function() { new Livesearch('searchform', 's', 'dynamic-content', 'current-content', lsUrl + '/searchloop.php', '&s=', 'searchload', 'Type and Wait to Search', 'searchreset', 'searchsubmit', 'go', '0'); } );