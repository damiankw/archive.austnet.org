...
-->
    ...
    <!-- header end -->
			...
			<div class="page-section">
				<div class="container">
					<h1 class="title text-center" id="op_request">Open Port Request</h1>
					<p class="lead text-center">"If you would like to request an open port exemption on your IP, please fill out the form below. Please use your registered AustNet account nickname & associated email address for verification purposes. NB: Only ONE IP is accepted and subject to approval."</p>
					<div class="space"></div>
					<div class="row">
						
						<form id="openport-form" method="post" action="submit_openport.php" role="form">
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="form_ip">IP *</label>
                                        <input id="form_ip" type="text" name="ip" class="form-control" placeholder="Please enter your IP *" required="required" data-error="IP is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="form_port">Port(s) *</label>
                                        <input id="form_port" type="text" name="port" class="form-control" placeholder="Please enter your port(s) *" required="required" data-error="Port(s) is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="form_message">Reason(s) *</label>
                                        <textarea id="form_message" name="message" class="form-control" placeholder="Type your reasons(s) here *" rows="4" required="required" data-error="Message is required."></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
