...
<head>
  ...
  <title>AustNet.org :: Routing Team</title>
  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <ul id="tabnav">
        ...
        <li><a href="routing_policies.php">Policies</a></li>
        <li><a href="#">Applications</a></li>
        <li><a href="routing_contacts.php">Contacts</a></li>
      </ul>
      <p><strong>Routing</strong></p>
      <p>The purpose of this web page is to provide a public face to the AustNet Routing Team.</p>
      <p>The AustNet Routing Team was formed to streamline the server link process. They work individually and as a team to ensure applications are reviewed, and properly handled.</p>
      <p>The committee is responsible for verifying new applications for correctness, for offering testlinks to qualified and needed servers, and for effecting and supervising those testlinks. Additionally, team members attempt to attract new applications, particularly from large corporate sponsors.</p>
      </div>
    </div>
    <div id="news">
